...
import { RealityCheckEngine } from './realityCheck.js';
...
class UnhypedCLI {
     ...
     */
    async scrapeReviewData(productName) {
     ...
     */
    async analyzeProduct(productUrl, socialUrl, options = {}) {
        ...
        try {
            ...
            const realityResult = await this.realityEngine.analyzeProduct(productData, socialData, reviewSummary);
     ...
     */
    async displayResults(result, options) {
...
program
    ...
    .action(async (productUrl, options) => {
