 ...
 */
export async function scrapeTikTok(page, url) {
    ...
    try {
        ...
        const videoData = await page.evaluate(() => {
            ...
            const getTextContents = (selector) => {
        ...
        const foundPromotionalKeywords = promotionalKeywords.filter(keyword => caption.toLowerCase().includes(keyword.toLowerCase()));
        // Determine if paid promotion is detected
        const paid_promotion_detected = foundPromotionalKeywords.length > 0 ||
