...
class Stage3TestData {
     ...
     */
    static getMockTikTokDataAuthentic() {
        return {
     ...
     */
    static getMockTikTokDataSponsored() {
        return {
     ...
     */
    static getMockReviewSummaryBalanced() {
        return {
            total_reviews: 156,
            sentiment_breakdown: {
                positive: 89,
     ...
     */
    static getMockReviewSummarySuspicious() {
        return {
            total_reviews: 87,
            sentiment_breakdown: {
                positive: 84,
...
class Stage3TestSuite {
     ...
     * Test 2: Authentic product analysis
     */
    async testAuthenticProductAnalysis() {
     ...
     * Test 3: Sponsored content detection
     */
    async testSponsoredContentDetection() {
     ...
     * Test 4: Ingredient quality analysis
     */
    async testIngredientQualityAnalysis() {
     ...
     * Test 6: Price value assessment
     */
    async testPriceValueAssessment() {
     ...
     * Test 7: Overall scoring logic
     */
    async testOverallScoringLogic() {
        console.log(chalk.cyan('🎯 Test 7: Overall Scoring Logic...'));
        try {
            const mockProduct = Stage3TestData.getMockProductData();
            // Test authentic scenario (should score higher)
            const authenticResult = await this.realityEngine.analyzeProduct(mockProduct, Stage3TestData.getMockTikTokDataAuthentic(), Stage3TestData.getMockReviewSummaryBalanced());
            // Test sponsored scenario (should score lower)
            const sponsoredResult = await this.realityEngine.analyzeProduct(mockProduct, Stage3TestData.getMockTikTokDataSponsored(), Stage3TestData.getMockReviewSummarySuspicious());
